...
function LoginPage({ setIsAuthenticated }) {
  ...
  return (
    <div class="loginPage">
      <div class="loginPage__leftHalf">
        <XIcon className="loginPage__xIcon" />
      </div>
      <div class="loginPage__rightHalf">
    ...
    <div class="line"></div>
          ...
          <Button onClick={handleLogin} className="loginPage__createAccountBtn">
            Create account
          </Button>
        </div>
        <div className="loginPage__alreadyAccount">Already have an account?</div>
        <div className="loginPage__signIn">
        <Button onClick={handleLogin} className="loginPage__signInBtn">
            Sign in
          </Button>
        </div>
      </div>
